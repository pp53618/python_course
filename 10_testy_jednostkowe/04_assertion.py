...
assertNoEqual - sprawdza czy dwa elementy nie są równe
assertTrue - sprawdza czy wyrażenie/element jest prawdą
assertFalse - sprawdza czy wyrażenie/element jest fałszywy
assertIn - sprawdza przynależnosć (czy należy)
